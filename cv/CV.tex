...
\vbox{
  ...
  \ \ \begin{easylist}[itemize]
    ...
    & Thesis: Explainable Deep Learning and Pre-processing Methods for Medical Image Analysis
  \end{easylist}
...
% columbia
\subsection{\href{http://www.nycmakerspace.org/}{NYC Makerspace}: Co-Founder
\DatestampYM{2017}{02} -- current }
...
\subsection{\href{http://www.creativemachineslab.com/}{Columbia University, Creative Machines Lab (Prof. Hod Lipson)}
...
& \textbf{Independent Research, advised by Prof. Hod Lipson
  ...
  && Multi-Agent Collaborative Reinforcement Learning simulator: \href{http://www.github.com/adgaudio/MACL}{MACL}.
\end{easylist}

\subsection{\href{http://buildinglink.com/}{BuildingLink}: Data Scientist
...
\subsection{\href{http://www.alluvium.io}{\textbf{Alluvium}}: Senior Data Scientist, 1st employee
...
\subsection{\href{http://www.sailthru.com}{\textbf{Sailthru}}: Senior Data Scientist and Engineer
...
\subsection{\href{http://www.adaptly.com}{\textbf{Adaptly}}: Developer
...
\vbox{\subsection{\href{http://www.flatworldknowledge.com}{\textbf{Flat World Knowledge}}: Software Engineer, Backend
...
\vbox{\subsection{\href{http://www.bard.edu/}{Bard College}: Systems Engineer
\DatestampYM{2009}{07} -- \DatestampYM{2010}{09}}
\begin{easylist}
  & In collaboration with REN-ISAC (Research \& Education Networking Information Sharing \&
  Analysis Center) and supervised by CTO BIll Terry, I built a darknet.
\end{easylist}
}
