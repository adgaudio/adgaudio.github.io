...
\vbox{
  ...
  \subsection{\href{http://www.jhu.edu}{\textbf{The Johns Hopkins University}}}
  \ \ \textbf{Postdoctoral Fellow in Electrical Computer Engineering}
  \hfill
  \textbf{\DatestampYM{2023}{09} -- Current}
  ...
  \ \ \textbf{Ph.D. in Electrical Computer Engineering}
  \hfill
  \textbf{\DatestampYM{2018}{08} -- \DatestampYM{2023}{08}}
  \ \ \begin{easylist}[itemize] \ListProperties(Space=0em, Space*=0em)
    & Advisors: Professor Asim Smailagic and Professor Aur{\'e}lio Campilho
    & Thesis: \href{https://doi.org/10.1184/R1/24103755}{Explainable Deep and Machine Learning for Medical Image Analysis (URL)}
  \end{easylist}
  ...
  \ \ \textbf{Master of Science in Electrical Computer Engineering}
  \hfill
  \textbf{\DatestampYM{2018}{08} -- \DatestampYM{2023}{05}}
  \ \ \begin{easylist}[itemize] \ListProperties(Space=0em, Space*=0em)
          & Advisors: Professor Asim Smailagic and Professor Aur{\'e}lio Campilho
  \end{easylist}
...
\section{Teaching}
% TODO: Teaching is NOT UPDATED in references.bib

\subsection{\small Spring 2025, Johns Hopkins University, Clinical Diagnostic Devices and Methods, Guest Lecturer}
...
\subsection{\small Fall 2023, Carnegie Mellon University, Mobile and Pervasive Computing (IoT), Mentor}
\begin{easylist} \ListProperties(Space=0em, Space*=0em)
...
% \printbibliography[keyword={teaching}, title={Teaching}]

\section{Industry Experience}

\subsection{\small\href{http://www.auscultationlab.com/}{Auscultation Lab, LLC}: Founder
\DatestampYM{2025}{04} -- Present }
\begin{easylist}[itemize] \ListProperties(Space=0em, Space*=0em)
  & View, annotate, structure and analyze acoustic cardiopulmonary datasets.
  & Consulting services for heart and lung sound analysis.
\end{easylist}
...
\begin{easylist}[itemize] \ListProperties(Space=0em, Space*=0em)
  & \href{https://vimeo.com/234396442}{ImageR}: Match images of packages to building residents.
  ...
  ImageR processes 50K packages a day, 18 million packages processed by Jan. 2021, launched May 2018.  Awarded Patent: 10803542
\end{easylist}
...
\begin{easylist}[itemize] \ListProperties(Space=0em, Space*=0em)
  & \href{https://www.businesswire.com/news/home/20141029005714/en/Sailthru-Announces-Sailthru-Sightlines-Bringing-Accurate-and-Automated-Consumer-Predictions-To-Ecommerce-and-Media-Brands}{Sightlines\textsuperscript{TM}} predicts user behavior.  I started the data science team and we architected a robust, fault tolerant and distributed platform and product offering.
...
\section{Awards}
\begin{easylist}
    % & \textbf{NIH K99/R00 Award} from National Institutes of Health NIBIB \hfill \DatestampYM{2026}{03}
    & \textbf{IGNITE Award} from Johns Hopkins University \hfill \DatestampYM{2026}{03}
    & \textbf{Regional NSF i-CORPS} Completion for Auscultation Lab \hfill \DatestampYM{2026}{03}
    & \textbf{Featured Article \& Cover Selection} in IEEE Transactions on Biomedical Engineering \hfill \DatestampYM{2025}{10}
    & \textbf{Technology Commercialization Award} for DeepPHDet Patent Family (via INESC TEC transfer office) \hfill \DatestampY{2025}
    & \textbf{Postdoctoral Fellowship} Awards from Johns Hopkins University \hfill \DatestampY{2023}, \DatestampY{2024}, \DatestampY{2025}
    & \textbf{Dual PhD Degree Fellowship} Award from Carnegie Mellon University, Portugal Program \hfill \DatestampYM{2018}{08}
    & \textbf{Champion of Social Justice} from the Wilson Major Morris Community Center in Harlem, NY \hfill \DatestampYM{2018}{01}
...
% \begin{easylist}
    % & InterSpeech 2025-6 \textbf{}  \hfill \DatestampYM{2026}{03}
% 
